...
from Products.meeting.config import PROJECTNAME
from Products.meeting.config import product_globals as GLOBALS


def install(self, reinstall=False):
    """ External Method to install meeting """
    out = StringIO()
    ...
    try:
        from Products.meeting.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    vocabmap = {'meeting_types': ('SimpleVocabulary', 'SimpleVocabularyTerm'),
         'document_types': ('SimpleVocabulary', 'SimpleVocabularyTerm'),
        }
    ...
    factory_types=[
        "Meeting",
        "MeetingDocumentCollection",
        "MeetingDocument",
        ] + factory_tool.getFactoryTypes().keys()
    factory_tool.manage_setPortalFactoryTypes(listOfTypeIds=factory_types)

    from Products.meeting.config import STYLESHEETS
    try:
        ...
        pass
    from Products.meeting.config import JAVASCRIPTS
    try:
    ...
    #setup_tool.setImportContext('profile-meeting:default')
